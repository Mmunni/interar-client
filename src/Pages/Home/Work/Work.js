    ...
    <div className="bg-secondary-color pt-24">
      <div className="works max-w-screen-xl mx-auto pb-44">
        <div className="title text-center">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold text-white pb-24">
            Our Easy Working Steps
          </h1>
        </div>
        <div className="process-icon-box  flex flex-col items-center sm:flex-col md:flex-col lg:flex-row lg:justify-around">
            <div className="single-process-icon mb-10 lg:pr-10">
            <div className="process-icon theme-color text-5xl">
            <FaBuilding />
          </div>
          <div className="process-details text-center">
            <div className="process-title mt-3 text-white text-2xl py-3">
              Visit Project
            </div>
